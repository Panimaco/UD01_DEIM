...
public class FromLargestToSmallest : MonoBehaviour
{
    ...
    private void GetSmallestToLargest() {
        ...
        if (NumberOne < NumberTwo && NumberOne < NumberThree) {
            ...
            //Si el número dos es menor que el tercero, se coloca al dos en el "int mid" y al tres en el "int large"
        ...
        if (NumberTwo < NumberOne && NumberTwo < NumberThree) {
            ...
            //Si el número uno es menor que el tercero, se coloca al uno en el "int mid" y al tres en el "int large"
        ...
        //Despliega la información resultante en un Debug.Log en orden de primero el "large", después el "mid" y por último el "small"
        Debug.Log("El orden descendente es " + large + " después " + mid + " y por último " + small + ".");
